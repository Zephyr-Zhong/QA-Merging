...
class GLUEDataLoader:
    ...
    def load_dataset(self, dataset_name: str, val_shot_from_train: int = 64, val_ratio_from_train: float = None, max_seq_length: int = 128):
        """
        ...
        permuted_indices = np.random.RandomState(
            seed=0).permutation(len(dataset["train"])).tolist()
