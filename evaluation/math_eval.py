...
def parse_args():
    ...
    parser.add_argument("--max_tokens_generate", default=4096, type=int)
...
def prepare_data(data_name, args):
    ...
    eval_dir = f"math_eval_{args.max_tokens_generate}"
    ...
    if args.use_vllm:
        ...
        if args.data_parallel_size <= 1:
            llm = LLM(
                ...
                enforce_eager=True,
                # dtype="bfloat16",
                max_model_len=args.max_tokens_generate+2048,
    ...
    for epoch in range(max_func_call):
        ...
        if args.use_vllm:
            ...
            outputs = generate_completions(
                ...
                tokenizer=tokenizer,
                prompts=prompts,
                max_new_tokens=args.max_tokens_generate,
                batch_size=16,
